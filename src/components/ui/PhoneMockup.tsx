  ...
  return (
    <div className="relative" aria-hidden="true">
      ...
      <motion.div
        ...
        className="absolute -top-4 -right-2 flex max-w-[210px] items-start gap-2 rounded-xl border border-slate-200 bg-white px-3 py-2.5 shadow-xl shadow-slate-900/10 sm:-right-10 dark:border-slate-700 dark:bg-slate-900 dark:shadow-black/40"
      >
